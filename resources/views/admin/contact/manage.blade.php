...
@section('content')
    @php
        if (isset($contact)) {
            $actionUrl = route('contact.update', $contact->id);
        } else {
            $actionUrl = route('contact.manage');
        }
    @endphp
                ...
                <div class="col-md-12">
                    <div class="card card-seccond">
                        <div class="card-header">
                            <h3 class="card-title">Kontak Perusahaan</h3>
                        </div>
                        <form id="submitContact" method="POST" action="{{ $actionUrl }}" enctype="multipart/form-data">
                            @if (@isset($contact))
                                {{ method_field('PUT') }}
                            ...
                            <div class="card-footer">
                                <button type="submit" submitContact="submit" class="btn btn-info btn-sm">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
